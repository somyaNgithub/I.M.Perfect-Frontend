...
<h3 className='text-4xl font-poppins text-Original font-bold'>       Welcome to IMPERFECT - Empowering Communities, Nurturing Lives
        </h3> 
   ...
   <div>
      ...
      <div>
        ...
        At [Your Project Name], we invite you to become a part of our growing community. By joining us, you're not only accessing a wealth of knowledge but also contributing to a culture of understanding and support.
        </div>
        <h3 className='text-2xl font-poppins text-Original font-bold'> 
          How You Can Get Involved  </h3>
        Ask Questions: Pose your questions to the community and receive insights from both experts and fellow parents.
        Share Your Story: Your journey is unique and valuable. Share your story to inspire and uplift others who may be going through similar experiences.
        Connect with Experts: Engage with specialists who offer expertise in various aspects of caring for special children.
        Together, let's create a community where every member feels heard, supported, and empowered. Join us on this meaningful journey at [Your Project Name].
    </div>
    </>
  )
}
