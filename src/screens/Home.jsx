...
import imageSrc from '../assets/march31.jpeg'
import imageSrc1 from '../assets/hero2.jpeg'
...
<div className='relative   '>
      ...
      pagination={true} modules={[Pagination ,Autoplay , A11y ,Navigation ]} className="mySwiper max-h-[450px]">
        ...
        <SwiperSlide key={1}>
                <Link to={'/ask-question'} className='w-full h-[400px] flex-col justify-center items-start flex px-5 gap-10  bg-Primary_p50 bg-center bg-contain'
      style={{
        backgroundImage:`url(${imageSrc1})`,
        backgroundRepeat:"no-repeat"
}}
    >
        <h4 className=' text-2xl md:text-[44px] font-calligraffitti font-bold text-white '></h4>
        <h5 className='text-lg md:text-2xl line-clamp-3 font-poppins font-semibold text-white ' >
          ...
          <SwiperSlide key={2}>
            <Link to={'/login'}  className='w-full h-[400px] flex-col justify-center items-start flex px-5 gap-10  bg-Primary_p50 bg-center bg-contain'
              style={{
    ...
    {/* our vision */}
    <div className='flex flex-col w-[95%] mx-auto justify-center items-center gap-5 md:gap-10  '>
                      <h3 className=' text-lg md:text-[36px] font-poppins font-medium text-center'>
                        <HeadingTags title={"Our Vision"}/>
                      </h3>
                      <div className='w-full flex flex-col gap-5'>
                      <p
                      className='w-full md:mx-5   justify-center  items-center font-poppins md:text-center font-normal text-lg md:text-xl '
                      >
    ...
    <div className='flex flex-col w-full  bg-Original bg-opacity-20 py-10 mx-auto justify-center items-center gap-5  md:gap-10  '>
    <h3 className='text-Secondary1_Neutral text-lg md:text-[36px] font-poppins font-medium text-center'>
                      ...
                      <p className='text-xl font-poppins font-normal md:mx-5 mx-2 md:text-center'>
