...
const ForgetPassword = () => {
    ...
    return (
        <div className='w-full justify-center items-center flex h-[70vh]  bg-gray-300'>
            <div className='max-w-[60vw]  mx-auto flex px-5 py-5 flex-col gap-5 justify-center items-start bg-white rounded-lg shadow-md  '>
                <h3 className='text-pink-400 text-2xl font-poppins font-semibold  '>Forget Password</h3>
                <div className='w-full space-y-5'>
                    ...
                    <button onClick={userLogin} className='bg-pink-300 rounded-lg w-full px-5 font-medium font-poppins text-white text-lg '>
                        Login
                    </button>
                    <button onClick={navigate(-1)} className=' bg-[#54063a] rounded-lg w-full px-5 font-medium font-poppins text-white text-lg '>
                        back
                    </button>
